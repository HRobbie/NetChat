package com.hrobbie.netchat.session;
...
import com.hrobbie.netchat.contact.activity.RobotProfileActivity;
import com.hrobbie.netchat.contact.activity.UserProfileActivity;
import com.hrobbie.netchat.session.action.AVChatAction;
import com.hrobbie.netchat.session.action.FileAction;
import com.hrobbie.netchat.session.action.GuessAction;
import com.hrobbie.netchat.session.action.RTSAction;
import com.hrobbie.netchat.session.action.SnapChatAction;
import com.hrobbie.netchat.session.action.TeamAVChatAction;
import com.hrobbie.netchat.session.action.TipAction;
import com.hrobbie.netchat.session.activity.MessageHistoryActivity;
import com.hrobbie.netchat.session.activity.MessageInfoActivity;
import com.hrobbie.netchat.session.extension.CustomAttachParser;
import com.hrobbie.netchat.session.extension.CustomAttachment;
import com.hrobbie.netchat.session.extension.GuessAttachment;
import com.hrobbie.netchat.session.extension.RTSAttachment;
import com.hrobbie.netchat.session.extension.SnapChatAttachment;
import com.hrobbie.netchat.session.extension.StickerAttachment;
import com.hrobbie.netchat.session.search.SearchMessageActivity;
import com.hrobbie.netchat.session.viewholder.MsgViewHolderAVChat;
import com.hrobbie.netchat.session.viewholder.MsgViewHolderDefCustom;
import com.hrobbie.netchat.session.viewholder.MsgViewHolderFile;
import com.hrobbie.netchat.session.viewholder.MsgViewHolderGuess;
import com.hrobbie.netchat.session.viewholder.MsgViewHolderRTS;
import com.hrobbie.netchat.session.viewholder.MsgViewHolderSnapChat;
import com.hrobbie.netchat.session.viewholder.MsgViewHolderSticker;
import com.hrobbie.netchat.session.viewholder.MsgViewHolderTip;
